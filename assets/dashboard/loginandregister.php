...
<head>
    ...
    <link rel="stylesheet" href="../css/loginandregister.php">
...
.right-log{right:30px !important;}
...
.login-show input[type="text"], .register-show input[type="email"], .login-show input[type="password"]{
    width: 100%;
    display: block;
    margin:20px 0;
    padding: 15px;
